...
3 is least priority equivalent to 192</toolTipHelpDescription>
  ...
  <provided xsi:type="ResourceModel:EnumerationParameter" name="Enable Interrupt" URI="http://www.infineon.com/1.0.28/app/nvic002/0/nvic002_erwenableint" multipleSelections="true">
    <defaultValue xsi:type="ResourceModel:IntegerValue" value="0"/>
    <localValue xsi:type="ResourceModel:StringValue" value="0"/>
  ...
  <provided xsi:type="ResourceModel:StringParameter" name="User defined interrupt handler" evalFunction="" URI="http://www.infineon.com/1.0.28/app/nvic002/0/nvic002_srwuserfunction">
  ...
  <provided xsi:type="ResourceModel:API" description="Function to configure the interrupts for all app instances&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;             base on user configuration" URI="http://www.infineon.com/1.0.28/app/nvic002/0/nvic002_init" APIName="NVIC002_Init">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <provided xsi:type="ResourceModel:API" description="Function to enable the IRQ" URI="http://www.infineon.com/1.0.28/app/nvic002/0/nvic002_enableirq" APIName="NVIC002_EnableIRQ">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <provided xsi:type="ResourceModel:API" description="Function to disable the IRQ" URI="http://www.infineon.com/1.0.28/app/nvic002/0/nvic002_disableirq" APIName="NVIC002_DisableIRQ">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
