...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="NVIC_DMA001" description="App provides DMA module specific handling&#xA; of Interrupt events.This App is included by &#xA;top level DMA apps to register callback function&#xA; to handle DMAx Unit Interrupt Events." descriptionURL="/doc/html/group___n_v_i_c___d_m_a001_app.html" mode="SHARABLE" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2">
  ...
  <provided xsi:type="ResourceModel:API" description="Function to configure DMA Interrupt priority and reset&#xD;&#xA;&#x9;&#x9;&#x9;&#x9;             all interrupt related registers to reset values" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2/nvic_dma001_init" APIName="NVIC_DMA001_Init">
    <localValue xsi:type="ResourceModel:StringValue" value="-1"/>
    <globalValue xsi:type="ResourceModel:StringValue" value="-1"/>
  </provided>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2/nvicnodedma">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2/resetapp">
  ...
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2/nvicnodedma/signal_in" isSystemDefined="true">
    <downWardmappedList xsi:type="ResourceModel:SignalDeclaration" href="../../CPU/CPU_0.dd#//@provided.94"/>
  </consumed>
  <consumed xsi:type="ResourceModel:ProxyResource" URI="http://www.infineon.com/1.0.16/app/nvic_dma001/2/nvicnodedma/ipr_pri" upWardMappingList="//@provided.1 //@provided.2" isSystemDefined="true">
